...
void solve()
{
    ...
    //     ans = min(ans, max((y + 1) / 2, (x + y + 2) / 3));
    // } //  this also works

    auto works = [](int totalop, int x, int y) -> bool
    {
        int l = 0, r = totalop + 1; // checking for a
    ...
    fo(i, n - 1)
    {
        ...
        int l = 0, r = 3e6; //  val of total hits (a + b)
