...
void solve()
{
    ...
    fo(i, n)
    {
        ...
        else if (a == 'x' and b == 'x')
        {
            if (x > y)
            {
                int newpeople = extra * (x - 1) + left * (x - 1) + right * (y - 1);
            ...
            {
                int newpeople = extra * (y - 1) + left * (x - 1) + right * (y - 1);
        ...
        else
        {
            if (a == 'x')
            {
                int newpeople = extra * (x - 1) + left * (x - 1) + y;
                left += extra;
            ...
            {
                int newpeople = extra * (y - 1) + right * (y - 1) + x;
                right += extra;
