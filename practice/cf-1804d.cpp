...
void solve()
{
    ...
    fo(i, n)
    {
        int cnt = count(vec[i].begin(), vec[i].end(), 1);
        int mxred = 0;               // two holding two light
        int inc = 0, couldplace = 0; //  two holding one light
