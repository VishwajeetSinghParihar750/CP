...
struct info
{
    bool allchildwork = false;
    bool iwork = false;
    int onechilddoesntwork = -1;
};
...
void dfs(int v, int p)
{
    ...
    int cntkidsdontwork = kidsdontwork.size();

    if (cntkidsdontwork > 2)
    {
        fails = true;
        return;
    }
    //
    else if (cntkidsdontwork == 2)
    {
        if (t[kidsdontwork[0]].allchildwork && t[kidsdontwork[1]].allchildwork)
        {
    ...
    else if (cntkidsdontwork == 1)
    {
        if (t[kidsdontwork[0]].allchildwork)
        {
            t[v].onechilddoesntwork = kidsdontwork[0];
        }
        else if (t[kidsdontwork[0]].onechilddoesntwork != -1)
        {
            //
