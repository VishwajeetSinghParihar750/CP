...
void solve()
{
    ...
    unordered_map<int, int> updatedCnt = ogcnt;
    int curn = n;
    while (q--)
    {
        int type;
        ...
        if (type == 1)
        {
            ...
            int prod = 1;
            for (auto [a, b] : updatedCnt)
            {
                prod *= (b + 1);
            }

            unordered_map<int, int> faxthis;
            ...
            for (auto [a, b] : faxthis)
            {
                if ((!updatedCnt.count(a)) || updatedCnt[a] < b)
                {
                    works = false;
                    break;
                }
