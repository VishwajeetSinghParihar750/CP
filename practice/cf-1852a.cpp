...
void solve()
{
    ...
    int curposOfPositionOne = 1;

    int curpointer = 0;
    fo(i, k)
    {

        while (curpointer < n and (vec[curpointer] - (curpointer + 1)) < curposOfPositionOne)
            curpointer++;

        curposOfPositionOne += curpointer;
    }

    println(curposOfPositionOne);
}
int32_t main()
{
#ifndef ONLINE_JUDGE
