...
void solve()
{
    ...
    int deninv = pqInverseMod(1ll, 10000ll, MOD1);
    ...
    fo(i, n)
    {
        ...
        int normprob = pqInverseMod(prob[i], 10000ll, MOD1);
        int invrprob = pqInverseMod(10000ll - prob[i], 10000ll, MOD1);
    ...
    vi dp(1 << 10); // this is prob of particular xor
    dp[0] = 1;
    ...
    fo(i, n)
    {
        ...
        fo(num, 1 << 10)
        {
            newdp[num] = (dp[num ^ vec[i]] * prob[i] + dp[num] * invprob[i]) % MOD1;
        }
